...
- **Task List:** A table task list , button for add, delete, or modify task, button for add favorite task in list , table to add new tasks with title, description, and optional tags or priority.
